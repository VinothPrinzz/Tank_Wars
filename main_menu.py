...
def options():
    while True:
        ...
        C1 = Button(image=pygame.image.load("PLAYER BUTTON/CONTROL1835.png"), pos=(500, 50), text_input="CONTROLS",
                    font=get_font(30), base_color="White",
                    hovering_color="Black")
        C1.changeColor(OPTIONS_MOUSE_POS)
        C1.update(SCREEN)

        P1 = Button(image=pygame.image.load("PLAYER BUTTON/UPDATE_P1.png"), pos=(220, 130), text_input="PLAYER ",
                    font=get_font(30), base_color="White",
                    hovering_color="Green")  # PLAYER 1 DISPLAY BUTTON
        P1.changeColor(OPTIONS_MOUSE_POS)
        P1.update(SCREEN)

        P2 = Button(image=pygame.image.load("PLAYER BUTTON/UPDATEP2.png"), pos=(800, 130), text_input="PLAYER ",
                    font=get_font(30), base_color="White",
        ...
        B5 = Button(image=None, pos=(200, 400), text_input="                 S   -  TURRENT DOWN", font=get_font(30),
                    base_color="White",
                    hovering_color="Green")
        ...
        PB2 = Button(image=None, pos=(750, 270), text_input=" ARROW [>]  -   RIGHT", font=get_font(30),
                     base_color="White", hovering_color="Red")
